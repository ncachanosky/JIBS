...
================================================================================
- Clean V-Party and Global Leader Ideology data
==============================================================================*/
...
foreach suf in leader leader_full full_seat full_vote seat vote {
	
	if "`suf'" == "leader" | "`suf'" == "leader_full" {
		cap qui sum std_pop_`suf'
		cap replace std_pop_`suf' = r(mean)
	}
		...
		foreach yy in _85_95 _95_05 _05_15 _15_25 {	
			
			cap qui sum std_pop_`suf'`yy'
			cap replace std_pop_`suf'`yy' = r(mean)
...
// Save
save "$path/JIBS/data/v-party-clean.dta", replace
