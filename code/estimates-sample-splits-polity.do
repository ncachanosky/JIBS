...
areg log_ch d0 d1 d2 d4 d5 d6 d7 i.cy, ///
	absorb(firm_id) cluster(iso)
...
cap drop post
gen byte post = (treat == 1 & rel_year >= 4)
areg log_ch d0 d1 d2 post i.cy [aweight=ebal], ///
	absorb(firm_id) cluster(iso)
...
areg log_ch d0 d1 d2 d4 d5 d6 d7 i.cy if treat==0 | lpop==1, ///
	absorb(firm_id) cluster(iso)
...
cap drop post
gen byte post = (lpop == 1 & rel_year >= 4)
areg log_ch d0 d1 d2 post i.cy if treat==0 | lpop==1 [aweight=ebal], ///
	absorb(firm_id) cluster(iso)
...
areg log_ch d0 d1 d2 d4 d5 d6 d7 i.cy if treat==0 | rpop==1, ///
	absorb(firm_id) cluster(iso)
...
cap drop post
gen byte post = (rpop == 1 & rel_year >= 4)
areg log_ch d0 d1 d2 post i.cy if treat==0 | rpop==1 [aweight=ebal], ///
	absorb(firm_id) cluster(iso)
