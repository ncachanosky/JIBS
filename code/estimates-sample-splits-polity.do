...
ebalance treat *_l1 *_l2 *_l3 if relative_year == 0, gen(_ebal)
...
keep if inlist(region, "Eastern Europe", "South-eastern Asia", "Southern Europe")
...
graph combine eEurope eAsia, ///
	xcommon rows(1)
graph export "$path/JIBS/output/plots/wild-by-region-polity.png", replace
